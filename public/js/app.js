...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    authorizedUser: function authorizedUser() {
      return this.$store.getters.user;
    },
    apiToken: function apiToken() {
      return this.$store.getters.apiToken;
  ...
  methods: {
    changeSort: function changeSort(direction) {
      this.sortByIdAsc = direction;
      this.fetchData();
    },
    canDeleteMessage: function canDeleteMessage(id) {
    ...
    canCreateMessage: function canCreateMessage() {
      if (this.authorizedUser) {
        return true;
      }
    ...
    fetchData: function fetchData() {
      ...
      this.error = null;
      this.loading = true;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/api/messages?page=' + this.page + '&sort=' + this.sortByIdAsc, {
        headers: {
        ...
        if (response.headers['x-count'] === undefined) {
          ...
          _this.last_page = parseInt(parseInt(response.headers['x-count']) / 3) + 1;

          if (_this.last_page <= 0) {
            _this.last_page = 1;
          }
        }

        if (_this.page === 1 && _this.messages.length === 0) {
          _this.message_text_is_open = true;
        }
    ...
    handleSubmitMessage: function handleSubmitMessage(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/messages', {
        ...
        _this2.message_text = null;
        _this2.message_title = null;

        _this2.setPage(1);
      })["catch"](function (error) {
        _this2.message_text_error = error.response.data.message || error.message; //this.message_title_error = error.response.data.title;

        _this2.riseMessageErrors(error.response.data.errors);
      });
    },
    riseMessageErrors: function riseMessageErrors(errors) {
      if (!errors) {
        return;
      }
    ...
    setPage: function setPage(goToPage) {
      this.page = goToPage;
      this.fetchData();
    },
    ...
    deleteMessage: function deleteMessage(id) {
      ...
      this.error = null;
      this.loading = true;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]('/api/messages/' + id, {
        headers: {
          Authorization: this.getAuthString()
        }
      }).then(function (response) {
  ...
  methods: {
    handleSubmit: function handleSubmit(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/login', {
        ...
        _this.updateUser(response.data.data.user, response.data.data.api_token);
      })["catch"](function (error) {
        _this.loading = false;
        _this.error = error.response.data.message || error.message;
      });
    },
    updateUser: function updateUser(user, api_token) {
      if (!user || !api_token) {
        return;
      } // Store User
  ...
  methods: {
    ...
    handleSubmit: function handleSubmit(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/register', {
        ...
        _this.loading = false; //this.updateUser(response.data.user, response.data.api_token);

        _this.success = true;
      })["catch"](function (error) {
        _this.loading = false;

        _this.riseErrors(error.response.data.errors);

        if (_this.nameError === null && _this.emailError === null && _this.passwordError === null) {
          _this.error = error.response.data.message || error.message;
        }
      });
    },
    riseErrors: function riseErrors(errors) {
      if (!errors) {
        return;
      }
        ...
        _c("div", { staticClass: "container" }, [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              !_vm.user
                ? _c("span", { staticClass: "nav-link ml-auto" }, [
                    _vm._v("%username%")
                  ])
                : _vm._e(),
              _vm._v(" "),
      ...
      _c("div", { staticClass: "blog-header" }, [
        _c("div", { staticClass: "container" }, [
          ...
          _c("p", { staticClass: "lead blog-description" }, [
            _vm._v(_vm._s(_vm.page_description))
          ])
        ])
      ]),
      _vm._v(" "),
    ...
    _c("div", { staticClass: "row mb-5" }, [
                    ...
                    "a",
                    {
                      ...
                      on: {
                        click: function($event) {
                          _vm.message_text_is_open = true
                        }
                      }
                    },
                    [_vm._v("Написать на стене")]
                  )
                : _vm._e()
            ])
          : _vm._e(),
        _vm._v(" "),
        _vm.canCreateMessage() && _vm.message_text_is_open
          ? _c("form", { staticClass: "mb-4 border-bottom" }, [
              _c("h3", [_vm._v("Написать на стене")]),
              _vm._v(" "),
              _c("div", { staticClass: "form-group" }, [
                _c("div", { staticClass: "form-group" }, [
                  _c("label", { attrs: { for: "message_title" } }, [
                    _vm._v("Заголовок сообщение")
                  ]),
                  _vm._v(" "),
                  _c("input", {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.message_title,
                        expression: "message_title"
                      }
                    ],
                    staticClass: "form-control",
                    class: { "is-invalid": _vm.messageTitleError !== null },
                    attrs: {
                      type: "text",
                      name: "message_title",
                      id: "message_title",
                    ...
                    domProps: { value: _vm.message_title },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.message_title = $event.target.value
                      }
                    }
                  }),
                  _vm._v(" "),
                  _vm.messageTitleError
                    ? _c("p", { staticClass: "invalid-feedback" }, [
                        _vm._v(_vm._s(_vm.messageTitleError))
                      ])
                    : _vm._e()
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("textarea", {
                    ...
                    staticClass: "form-control",
                    class: { "is-invalid": _vm.messageTextError !== null },
                    attrs: {
                      id: "message_text",
                      name: "message_text",
                  ...
                  _vm._v(" "),
                  _vm.messageTextError
                    ? _c("p", { staticClass: "invalid-feedback" }, [
                        _vm._v(_vm._s(_vm.messageTextError))
                      ])
                    : _vm._e()
                ])
              ]),
              ...
              _c("input", {
                ...
                on: { click: _vm.handleSubmitMessage }
              }),
              _vm._v("    \n                "),
              _c("input", {
                staticClass: "btn btn btn-light",
                attrs: { type: "submit", value: "Омена" },
                on: {
                  click: function($event) {
        ...
        _c("nav", { attrs: { "aria-label": "Page navigation example" } }, [
          _c(
            ...
            [
              _c("li", { staticClass: "page-item" }, [
                _c(
                  "a",
                  {
                    ...
                    attrs: { disabled: !_vm.hasPrevPage(), href: "#" },
                    on: {
                      click: function($event) {
                        return _vm.prevPage()
                      }
              ...
              _vm._v(" "),
              _vm._l((_vm.page, _vm.last_page), function(i) {
                return _c(
                  "li",
                  {
                    staticClass: "page-item",
                    class: { active: i === _vm.page }
                  },
                  [
                    _c(
                      "a",
              ...
              _c("li", { staticClass: "page-item" }, [
                _c(
                  ...
                  {
                    staticClass: "page-link",
                    attrs: { disabled: !_vm.hasNextPage(), href: "#" },
                    on: {
                      click: function($event) {
                        return _vm.nextPage()
                      }
      ...
      _vm.messages.length > 0
        ? _c("div", { staticClass: "col-sm-3 offset-sm-1 blog-sidebar" }, [
            _c("div", { staticClass: "sidebar-module sidebar-module-inset" }, [
              _c("h5", [_vm._v("Сортировка")]),
              _vm._v(" "),
              _vm.sortByIdAsc === 0
                ? _c("p", [
                    _c(
              ...
              _vm.sortByIdAsc === 1
                ...
                : _vm._e(),
              _vm._v(" "),
              _c("h5", [_vm._v("Статистика страницы")]),
              _vm._v(" "),
              _c("p", [
                _vm._v(
                  "Всего постов на странице: " + _vm._s(_vm.messages.length)
                )
              ]),
              _vm._v(" "),
              _c("p", [
                _vm._v("Дата первого:"),
                _c("br"),
                _vm._v(_vm._s(_vm.messages[0].created_at))
              ]),
              _vm._v(" "),
              _c("p", [
                _vm._v("Дата последнего:"),
                _c("br"),
                _vm._v(_vm._s(_vm.messages[_vm.messages.length - 1].created_at))
              ]),
              _vm._v(" "),
              _c("p", [
                _vm._v("Автор первого:"),
                _c("br"),
                _vm._v(_vm._s(_vm.messages[0].user.name))
              ]),
              _vm._v(" "),
              _c("p", [
                _vm._v("Автор последнего:"),
                _c("br"),
                _vm._v(_vm._s(_vm.messages[_vm.messages.length - 1].user.name))
              ])
            ])
          ])
        : _vm._e()
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row mb-5" }, [
      _c("div", { staticClass: "col-sm-12 blog-main" }, [
        _c("form", [
          _vm.error
            ? _c(
                "div",
        ...
        _vm.success
          ? _c("div", { staticClass: "jumbotron" }, [
              _c("h1", { staticClass: "display-3" }, [
                _vm._v("Вы зарегистрированы")
              ]),
              _vm._v(" "),
              _c("p", { staticClass: "lead" }, [
                _vm._v("Добро пожаловать в огромное сообщество великой стены")
              ]),
              _vm._v(" "),
              _c("hr", { staticClass: "my-4" }),
              _vm._v(" "),
              _c("p", [
                _vm._v("Для продолжения работы вам нужно авторизоваться")
              ]),
              _vm._v(" "),
              _c(
                "p",
          ...
          ? _c("form", [
              ...
              _c("div", { staticClass: "form-group" }, [
                ...
                _c("input", {
                  ...
                  staticClass: "form-control",
                  class: { "is-invalid": _vm.emailError !== null },
                  attrs: {
                    id: "email",
                    type: "email",
                    placeholder: "Email",
              ...
              _c("div", { staticClass: "form-group" }, [
                _c(
                  "label",
                  { staticClass: "sr-only", attrs: { for: "user_login" } },
                ...
                _c("input", {
                  ...
                  staticClass: "form-control",
                  class: { "is-invalid": _vm.nameError !== null },
                  attrs: {
                    id: "user_login",
                    type: "email",
              ...
              _c("div", { staticClass: "form-group" }, [
                ...
                _c("input", {
                  ...
                  staticClass: "form-control",
                  class: { "is-invalid": _vm.passwordError !== null },
                  attrs: {
                    id: "user_password",
                    type: "password",
                    placeholder: "Пароль",
...
/* harmony import */ var _views_Home__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/Home */ "./resources/assets/js/views/Home.vue");
...
var store = new vuex__WEBPACK_IMPORTED_MODULE_2__["default"].Store({
  ...
  mutations: {
    ...
    apiToken: function apiToken(state, payload) {
      state.api_token = payload;
    },
    initialiseState: function initialiseState(state) {
...
module.exports = __webpack_require__(/*! /home/abelardo/projects/twin.test-task.board/resources/assets/js/app.js */"./resources/assets/js/app.js");
